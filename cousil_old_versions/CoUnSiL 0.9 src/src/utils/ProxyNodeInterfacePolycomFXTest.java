...
/**
 * JUnit test for ProxyNodeInterfacePolycomFX
 * <p/>
 * User: Milos Liska (xliska@fi.muni.cz)
 * Date: 9.4.2009
 * Time: 14:59:17
 */
public class ProxyNodeInterfacePolycomFXTest extends TestCase {
    String targetHost = "polycom.fi.muni.cz";
    String targetIP = "147.251.54.17";
    int targetPort = 24;
    String password = "1234";

    String reachableIP = "147.251.54.10";
    String unreachableIP = "192.168.1.1";
    String connectIP = "147.251.3.53";
    ...
    public void testPolycomConnection() {
        ...
        ProxyNodeInterfacePolycomFX polycom = new ProxyNodeInterfacePolycomFX(targetHost, targetPort, password);
        ...
        output = polycom.send("hangup video");
        System.out.println("call output:\n" + output);
    ...
    public void testPolycomConnection2() {
        ...
        System.out.println("Creating new connection instance to a Polycom device");
        ProxyNodeConnection connection = new ProxyNodeConnection(new ProxyNodeInterfacePolycomFX(targetHost, targetPort, password));
        ...
        System.out.println("Hanging up");
        try {
            output = connection.send("hangup video");
            System.out.println("call output:\n" + output);
        } catch (ProxyNodeConnection.ProxyNodeCommandFailed proxyNodeCommandFailed) {
            proxyNodeCommandFailed.printStackTrace();
        }
